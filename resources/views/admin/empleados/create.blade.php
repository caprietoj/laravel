    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.empleados.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apellido') ? 'is-invalid' : '' }}" type="text" name="apellido" id="apellido" value="{{ old('apellido', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identificacion') ? 'is-invalid' : '' }}" type="number" name="identificacion" id="identificacion" value="{{ old('identificacion', '') }}" step="1">
